...
function Howtouse() {
  return (
    <div id='Howtouse' className='h-[50vh] sm:h-[85vh] pt-[10vh] flex flex-col gap-4 justify-center items-center'>
      <h1 className='text-4xl sm:text-5xl md:text-6xl text-center font-extrabold'>How To Use</h1>
    <div className="h-0 pb-[230px] w-[300px] md:pb-[450px] sm:pb-[400px] sm:w-[600px] relative overflow-hidden md:w-[700px]">
