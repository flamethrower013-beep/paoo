...
function Howtouse() {
  return (
    ...
    <div className="h-0 pb-[280px] w-[370px] md:pb-[460px] sm:pb-[400px] sm:w-[600px] relative overflow-hidden md:w-[700px]">
      <iframe className='absolute top-0 left-0 w-full h-full rounded pt-[8vh]' src="https://www.youtube.com/embed/ITgL3R3BxRw?si=qDYw9CUxWLjwmFol" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen/>
    </div>
    </div>
  )
}
